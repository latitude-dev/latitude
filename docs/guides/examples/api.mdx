...
To access the API, you can use any HTTP client, such as `curl`, Postman, or even your browser. For example, to access the `/queries/sample_agg` endpoint, you can run the following command in your terminal:

```bash
curl http://localhost:3000/queries/sample_agg
```
