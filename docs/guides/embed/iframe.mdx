...
<Note>
If you're using React, we recommend using the [React component](/react/getting-started/embedding-views) to embed a Latitude data app in your React application.
</Note>
