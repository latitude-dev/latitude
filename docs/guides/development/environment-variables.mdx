...
Any env vars declared in this file will be accessible to your views. To learn more you can check the [Svelte documentation](https://learn.svelte.dev/tutorial/env-static-private).
