...
<Warning>Be careful setting `materialize: true` in all the source. It will materialize all the queries. Is better to set this setting at query level as explained in [queries documentation](/queries/advanced/config)</Warning>
