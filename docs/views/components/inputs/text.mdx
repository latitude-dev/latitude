...
<Note>When an input is empty, the parameter will NOT be sent in any query request. This means that you will want to add a fallback to your query to handle this case. For more information, check out [Query Parameters](/queries/logic/parameters)</Note>
