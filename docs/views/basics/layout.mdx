...
|----------|-------------|
| `theme`  | The theme to use for the view. Learn more about themes [here](/views/customization/global-styles). |
...
| -------- | ----------- | ------ |
| `gap` | The gap between the children of the row. Gaps are multiplied by 4 to get the actual gap in pixels. | `4`, `8`, `12`, `16`, `20`, `24`, `28`, `32` |
