---
title: 'Run Query'
description: 'Dynamically executes SQL queries, ideal for generating reports with runtime-known values.'
---
...
To access a specific column within the query, you can wrap it in a variable
``` 
...
This approach is essential for creating dynamic SQL queries that adapt based on actual database content, which is not directly possible with standard SQL due to its static nature.