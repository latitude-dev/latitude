...
const config = {
  ...
  theme: {
    ...
    extend: {
      ...
      screens: {
        sm: 'var(--lat-breakpoint-mobile)px',
        md: 'var(--lat-breakpoint-tablet)px',
        lg: 'var(--lat-breakpoint-desktop)px',
        xl: 'var(--lat-breakpoint-wide)px',
        '2xl': 'var(--lat-breakpoint-ultraWide)px',
      },
    },
  },
}
