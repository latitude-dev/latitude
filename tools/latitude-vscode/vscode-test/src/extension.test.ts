...
export default async function run() {
  ...
  describe('Extension configuration', function () {
    it('Imports the extension', async () => {
      const extension = vscode.extensions.getExtension('LatitudeData.latitude-vscode');
      const fakeExtension = vscode.extensions.getExtension('LatitudeData.latitude-vscode-fake');
